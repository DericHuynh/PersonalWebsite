...
import { CodeBracketSquareIcon, Cog8ToothIcon, DocumentIcon, ListBulletIcon, ClipboardDocumentListIcon } from '@heroicons/react/24/outline'
        ...
        <Disclosure as="nav" className="flex flex-row h-full border-r-2 border-gray-800" defaultOpen={true}>
            ...
            >
                <DisclosurePanel className="px-2 flex flex-col gap-3 text-white border-r-2 border-gray-800">
                    ...
                    <Link className="px-1 bg-slate-800 shadow rounded hover:bg-gray-700 flex flex-row items-center gap-1.5 pr-1.5" href="/about"><ListBulletIcon className="size-5"/>About</Link>
