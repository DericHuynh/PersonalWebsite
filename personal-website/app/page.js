  ...
  return (
    <main className="w-full flex flex-col from-gray-900 to-blue-900 bg-gradient-to-t">
      ...
      <div className="w-full flex flex-col gap-2 p-2 overflow-y-auto">
        ...
        <p className="m-auto text-center border-2 px-3 rounded-full bg-gray-900 font-serif border-gray-800">Deric Huynh</p>
        <div className="flex flex-col gap-2">
          <p className="indent-5 px-1.5 bg-gray-900 rounded-md border-2 border-gray-800">
          ...
          <p className="flex flex-row indent-5 px-1.5 bg-gray-900 rounded-md border-2 border-gray-800">
